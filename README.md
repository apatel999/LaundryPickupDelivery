...
```json
"ConnectionStrings": {
  "DefaultConnection": "Server=localhost;Database=LaundryLoopdDb;Trusted_Connection=True;TrustServerCertificate=True;"
}
```

Azure SQL example:
```
Server=tcp:yourserver.database.windows.net,1433;Database=LaundryLoopdDb;User ID=youruser;Password=yourpassword;Encrypt=True;
```
