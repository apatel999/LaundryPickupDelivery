using LaundryLoopd.Api.Data;
using LaundryLoopd.Api.Models;
using Microsoft.AspNetCore.Mvc;

namespace LaundryLoopd.Api.Controllers;
...
public class BookingsController : ControllerBase
{
    ...
    // ─────────────────────────────────────────
    // GET /api/bookings?page=1&pageSize=20&status=Pending
    // ─────────────────────────────────────────
    [HttpGet]
    ...
    {
        var (total, items) = await _repo.GetAllAsync(page, pageSize, status);
